...
const t2deviceTypes: Record<string, T2Factory> = {
    ...
    ['F3P2CYUBE__']: F3P2CYUBE__, // LG WM4000HBA front-load washer — 0xDE status frames, NOT 0xEC/0xEB, so it
    // cannot alias F3L2CYU__ despite the near-identical model ID
