        ...
        this.setConfig(
            allowExtendedType({
                ...
                components: {
                    ...
                    washer_detergent_state: {
                        platform: 'binary_sensor',
                        unique_id: '$deviceid-washer-detergent-state',
                        state_topic: '$this/washer/detergent_state',
                        device_class: 'problem',
                        payload_on: 'FULL',
                        payload_off: 'EMPTY',
                        name: 'Washer detergent',
                    },
                    washer_softener_state: {
                        platform: 'binary_sensor',
                        unique_id: '$deviceid-washer-softener-state',
                        state_topic: '$this/washer/softener_state',
                        device_class: 'problem',
                        payload_on: 'FULL',
                        payload_off: 'EMPTY',
                        name: 'Washer softener',
                    },
                    dryer_door: {
                        platform: 'binary_sensor',
