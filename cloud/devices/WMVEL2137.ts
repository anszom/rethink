...
// rec[10]: power level 0-10, matching LWOMGTPowerLevel exactly. Published as the percentage the
// panel shows ("50" for level 5), which is also how WMVEM1825 exposes it.
const POWER_LEVEL_OFFSET = 10
const POWER_LEVEL_SCALE = 10
...
export default class Device extends AABBDevice {
    ...
    processStatus(rec: Buffer) {
        ...
        this.publishProperty('power_level', rec[POWER_LEVEL_OFFSET] * POWER_LEVEL_SCALE)
